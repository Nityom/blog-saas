...
const VideoIcon = ({ src, size = 72 }: { src: string; size?: number }) => {
...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative h-[100vh] overflow-hidden flex flex-col items-center"
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="flex items-center justify-center gap-3 flex-wrap text-white">
            ...
            <VideoIcon
              src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260424_093237_ff0ddc63-c068-4e29-96da-fdd0e40af133.mp4"
              size={110}
            />
            <span>AI</span>
          </span>
