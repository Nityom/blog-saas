...
function VideoIcon({ src, size = 72 }: { src: string; size?: number }) {
  ...
  return (
    <span
      ...
      style={{ width: `clamp(48px, 10vw, ${size}px)`, height: `clamp(48px, 10vw, ${size}px)` }}
    >
      <video
        ref={videoRef}
        autoPlay
      ...
      >
        ...
        <div className="flex items-center gap-4 mt-6 flex-wrap justify-center">
          ...
          <a
            ...
            style={{ color: "#666", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 6 }}
          >
            See how it works
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M7 2v10M2 7l5 5 5-5" stroke="#666" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </a>
        </div>
      </div>
